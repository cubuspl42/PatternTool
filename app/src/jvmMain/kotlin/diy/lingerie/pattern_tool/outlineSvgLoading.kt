...
fun Outline.Companion.loadSvg(
    ...
    val closedSplineInternal = svgPath.toClosedSpline()

    val closedSplineMm = closedSplineInternal.transformBy(
        transformation = transformationToMm,
    )

    return Outline.reconstruct(
        closedSpline = closedSplineMm,
